...
//
	   	ManagedResource.Registration idm = registration.registerManagedResource(description("IDM (Model Object for Portal) Managed Resource, responsible for handling management operations on users, groups, membership types and memberships."));
...
//
	   	idm.registerOperationHandler(OperationNames.READ_RESOURCE, new IdmReadResource(), description("Lists available site types for a portal"));
//
